...
1. To confirm the backup data is mounted correctly into the docker container, run
    ...
    -rwxrwxrwx    1 backintime users          147 Dec 30  2016 info.txt
    -rwxrwxrwx    1 backintime users        40441 Dec  3 20:21 inodes.ods
